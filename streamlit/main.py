...
st.markdown("This dashboard showcases an end-to-end automated <a href='https://github.com/arnavrneo/Nifty50-Data-Engineering'>data engineering pipeline</a>. The data is fetched from *nseindia* website. <br/>*Note: The data may be stale.*", unsafe_allow_html=True)
...
with a2:
    st.markdown("<center>Made by: <a href='https://www.github.com/arnavrneo'>arnavrneo</a></center>", unsafe_allow_html=True)
