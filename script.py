...
class NSEIndicesData(Helper):
    ...
    def fetch_nse_index_symbols(self):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f'Error fetching index symbols: {e}'
            )

    def get_nse_indices_symbols(self):
        return {'index_symbols': self.fetch_nse_index_symbols()}
...
if __name__ == '__main__':
    ...
    ratios = indicesClass.get_nse_indices_ratios('Nifty 50', '12-Jul-2024', '12-Jul-2024', 'Nifty 50')
    
    # NSE Equities
    equitiesClass = NSEEquitiesData()
    ticker_list = equitiesClass.get_nse_equity_tickers()
    sec_archives = equitiesClass.get_security_wise_archive('TCS', '14-07-2024', '16-07-2024', 'ALL')
